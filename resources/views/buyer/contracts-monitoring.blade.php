...
@section('dashboard')
    <div>
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('buyer.contract-monitoring-create') }}" class="btn btn-success btn-xs mb-4">Tambah
                    Pekerjaan</a>
                    ...
                    <table id="datatable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center pr-0" style="vertical-align: middle; width: 25%;">Nilai Pekerjaan
                                    (Rp)</th>
                            ...
                            @foreach ($contracts as $contract)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"> <a
                                            href="{{ route('buyer.contract-monitoring', $contract->id) }}"
