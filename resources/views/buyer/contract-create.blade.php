            ...
            <div class="card-body">
                <form action="{{ route('buyer.contract-monitoring-store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-form-label-xs" for="name">Nama Pekerjaan<span
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-form-label-xs" for="oe">Nilai Kontrak<span
                                class="required">*</span></label>
                        <input type="int" class="form-control form-control-sm @error('oe') is-invalid @enderror"
                            value="{{ old('oe') }}" id="oe" name="oe">
                        @error('oe')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-form-label-xs" for="no_sp">No SP<span
                                class="required">*</span></label>
                        <input type="int" class="form-control form-control-sm @error('no_sp') is-invalid @enderror"
                            value="{{ old('no_sp') }}" id="no_sp" name="no_sp">
                        @error('no_sp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form-control-sm @error('date_sp') is-invalid @enderror"
                            value="{{ old('date_sp') }}" id="date_sp" name="date_sp">
                        @error('date_sp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-form-label-xs" for="template_id">Template<span
                                class="required">*</span></label>
                        <select id="template_id" name="template_id"
                            class="form-control form-control-sm select2bs4 @error('template_id') is-invalid @enderror"
                            style="width: 100%;" data-placeholder="-- Pilih --">
                            <option value=''></option>
                            @foreach ($templates as $template)
                                @if (old('template_id'))
                                    <option value="{{ $template->id }}" {{ old('template_id') ? 'selected' : '' }}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-7">
                            <label class="col-form-label col-form-label-xs" for="vendor_id">Vendor<span
                                    class="required">*</span></label>
                            <select class="form-control form-control-sm" name="vendor_id[]" data-placeholder="-- Pilih --">
                                <option value=''></option>
