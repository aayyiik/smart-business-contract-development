...
@section('page-title', 'Approval Kontrak')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-group row">
                        <label for="address" class="col-sm-2 col-form-label">Tanggal Disetujui</label>
                        <div class="col-sm-10">
                            @if ($contracts->pivot->status_id != 9)
                                <input type="text" class="form-control" id="address" value="Menunggu Persetujuan"
                                    readonly>
                            @else
                                <input type="text" class="form-control" id="address"
                                    value="{{ $approvals->created_at->format('d-m-Y') }}" readonly>
                            @endif
                        </div>
                    </div>
                </form>
