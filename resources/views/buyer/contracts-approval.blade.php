...
@section('page-title', 'Proses Approval')
...
<div>
    <div class="card">
        <div class="card-header card-forestgreen">
            <h6 class="card-title pt-1">Approval</h6>
                ...
                <table id="datatable" class="table table-sm table-hovered table-bordered table-hover table-striped datatable2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;"> <a href="{{ route('buyer.contract-approval', ['contract' => $contract->contract_id, 'vendor' => $contract->vendor_id]) }}" class="btn btn-primary btn-xs"><b>Rincian</b></a>
                        </tr>
                        @endif
                        @endforeach
                    </tbody>
