...
@section('page-title', 'Review Vendor Kontrak')
            ...
            <div class="card-body">
                @if ($contracts->pivot->status_id == 2)
                    <div class="mb-3">
                        ...
                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#review">Review
                            Hukum</a>
                        <a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#avp">Kirim Ke
                            AVP</a>
                    </div>
                @endif
                <form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="d-inline"
                        action="{{ route('buyer.contract-review-vendor-return', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                        method="POST">
                        @csrf
                        @method('post')
    ...
    <div class="modal fade" id="review" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="d-inline"
                        action="{{ route('buyer.contract-review-vendor-review', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                        method="POST">
                        @csrf
                        @method('post')
                        <div class="form-group">
    ...
    <div class="modal fade" id="avp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="d-inline"
                        action="{{ route('buyer.contract-vendor-avp', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                        method="POST">
                        @csrf
                        @method('post')
                        <div class="form-group">
