...
@section('page-title', 'Proses Review Vendor')
@section('buyer-review-vendor', 'active')
@section('address')
    <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item active">Review Vendor</li>
    </ol>
@endsection
@push('styles')
    <style>
    ...
    <div>
        <div class="card">
            <div class="card-header card-forestgreen">
                <h6 class="card-title pt-1">Review Vendor</h6>
                                ...
                                @if ($contract->contract->user_detail_id == Auth::user()->userDetail->id)
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align: middle;"> <a
                                                href="{{ route('buyer.contract-review-vendor', ['contract' => $contract->contract_id, 'vendor' => $contract->vendor_id]) }}"
