                    ...
                    <table id="pekerjaanTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center pr-0" style="vertical-align: middle; width: 15%;">Status</th>
                            ...
                            @foreach ($contracts as $contract)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"> <a
                                            href="{{ route('legal.contract', ['contract' => $contract->contract_id, 'vendor' => $contract->vendor_id]) }}"
