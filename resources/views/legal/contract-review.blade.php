    ...
    <div>
        ...
        @if ($contracts->pivot->status_id < 4)
            <div class="card">
                ...
                <div class="card-body">
                    <form
                        action="{{ route('legal.contract-approval', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                        method="POST">
                        @csrf
                        @method('post')
                        ...
                        <div class="row justify-content-end mr-0">
                            <button type="submit" name="return" class="btn btn-danger btn-xs text-right mr-2"
                                data-toggle="confirmation" data-placement="left">Kembalikan</button>
                            <button type="submit" name="process" class="btn btn-success btn-xs text-right"
                                data-toggle="confirmation" data-placement="left">Proses Lanjut</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <table
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center pr-0" style="vertical-align: middle; width: 20%;">Nama Reviewer
                                </th>
