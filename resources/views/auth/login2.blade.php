        ...
        <div class="modal">
            <div class="modal-container">
                <div class="modal-left">
                    <img src="{{ asset('../../assets/img/sintract-02.png') }}" class="logo" width="50%">
                    <p class="modal-desc">Silahkan login menggunakan akun yang diberikan oleh Admin</p>
                ...
                <div class="modal-right">
                    <img src="{{ asset('../../assets/img/lobby_petro.jpg') }}" alt="">
                </div>
