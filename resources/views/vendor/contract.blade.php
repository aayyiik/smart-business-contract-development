...
@section('dashboard')
    <div>
        <div class="card">
            ...
            <div class="card-body">
                @if ($contracts->pivot->status_id == 1 || $contracts->pivot->status_id == 2)
                    <div class="mb-4">
                        <a href="{{ route('vendor.contract-edit', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                            class="btn btn-success btn-xs">Edit Data Kontrak</a>
                    </div>
                @else
                    <div class="mb-4">
                        <a href="{{ route('vendor.contract-edit', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                            class="btn btn-success btn-xs" disabled>Edit Data Kontrak</a>
                    </div>
                @endif
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="number" value="{{ $contract->no_sp }}"
                                readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="number" value="@currency($contracts->pivot->contract_amount)" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        @elseif ($contracts->pivot->status_id == 10)value="SIGN CONTRACT"
                        @elseif ($contracts->pivot->status_id == 11)value="FINAL CONTRACT" @endif
                                readonly>
                        </div>
                    </div>
                </form>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation" style="width: 50%;">
                        <a class="nav-link text-center active" id="draft-tab" data-toggle="tab" data-target="#draft"
                            href="#draft" role="tab" aria-controls="draft" aria-selected="true">DRAFT KONTRAK</a>
                    </li>
                    <li class="nav-item" role="presentation" style="width: 50%;">
                        <a class="nav-link text-center" id="vendor-tab" data-toggle="tab" data-target="#vendor"
                            href="#vendor" role="tab" aria-controls="vendor" aria-selected="false">FINAL KONTRAK</a>
                    </li>
                </ul>
