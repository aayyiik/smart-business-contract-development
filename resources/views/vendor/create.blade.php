                        ...
                        <div class="col-md-5 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('number') }}" id="number" name="number" placeholder="Uraian number">
                                @error('number')
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-form-label-xs" for="director">Direktur<span
                                        class="required">*</span></label>
                                <input type="text"
                                    class="form-control form-control-sm @error('director') is-invalid @enderror"
                                    value="{{ old('director') }}" id="director" name="director" placeholder="director">
                                @error('director')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('phone') }}" id="phone" name="phone" placeholder="phone">
                                @error('phone')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('address') }}" id="address" name="address" placeholder="address">
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
