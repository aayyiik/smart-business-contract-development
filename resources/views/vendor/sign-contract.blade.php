...
@section('dashboard')
    <div>
            ...
            <div class="card-body">
                <div class="mb-3">
                    @if ($contracts->pivot->status_id == 9)
                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#rekanan">Kirim ke
                            Rekanan</a>
                    @endif
                </div>
                <form>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{ route('vendor.contract-upload', ['contract' => $contracts->pivot->contract_id, 'vendor' => $contracts->pivot->vendor_id]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="kontrak"
                                class="custom-file-input @error('kontrak') is-invalid @enderror"
                                value="{{ old('kontrak') }}" id="kontrak">
                            <label class="custom-file-label" for="kontrak" style="font-size: 12px !important;">Choose
                                file</label>
