                        ...
                        <tbody>
                            @foreach ($vendors as $v)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">{{ $v->userDetail->user->name }}
                                    </td>
                                    <td class="text-center" style="vertical-align: middle;">
                                        <a href="{{ route('superadmin.vendors-edit', $v->id) }}" class="btn btn-warning"><i
                ...
                <div class="modal-body">
                    <form class="d-inline" action="{{ route('superadmin.vendors-store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select id="user_detail_id" name="user_detail_id" data-reorder="1"
                                    class="form-control form-control-sm select2bs4 @error('user_detail_id') is-invalid @enderror"
                                    style="width: 100%;" data-placeholder="-- Pilih --">
                                    <option value=''></option>
                                    @foreach ($usersdetail as $ud)
                                        <option value="{{ $ud->id }}">{{ $ud->user->nik }} - {{ $ud->user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
