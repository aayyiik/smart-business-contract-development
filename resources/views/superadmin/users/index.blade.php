                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"> <a
                                            href="{{ route('superadmin.users-detail', ['id' => $user->id]) }}"
                                            class="btn btn-primary btn-xs"><b>Detail</b></a>
                                </tr>
                            @endforeach
                        </tbody>
                    </table><br>
                ...
                <div class="modal-body">
                    <form class="d-inline" action="{{ route('superadmin.users-store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select id="role_id" name="role_id" data-reorder="1"
                                    class="form-control form-control-sm select2bs4 @error('role_id') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select id="department_id" name="department_id" data-reorder="1"
                                    class="form-control form-control-sm select2bs4 @error('department_id') is-invalid @enderror"
                                    style="width: 100%;" data-placeholder="-- Pilih --">
                                    <option value=''></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select id="unit_id" name="unit_id" data-reorder="1"
                                    class="form-control form-control-sm select2bs4 @error('unit_id') is-invalid @enderror"
                                    style="width: 100%;" data-placeholder="-- Pilih --">
                                    <option value=''></option>
