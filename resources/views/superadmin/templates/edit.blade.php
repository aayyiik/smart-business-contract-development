...
@section('superadmin-templates', 'active')
@section('address')
    ...
    <div>
        <div class="card">
            <div class="card-header card-forestgreen">
                <h6 class="card-title pt-1">Edit Data Template</h6>
            ...
            <div class="card-body">
                <form action="{{ route('superadmin.templates-update', ['id' => $templates->id]) }}" method="POST">
                    @csrf
                    @method('put')
