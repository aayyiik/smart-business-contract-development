...
<div>
    <div class="card">
        ...
        <div class="card-header card-forestgreen">
            <h6 class="card-title pt-1">Data Status</h6>
                ...
                <table id="pekerjaanTable" class="table table-sm table-hovered table-bordered table-hover table-striped datatable2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">{{ $s->status }}</td>
                            <td class="text-center" style="vertical-align: middle;"><a href="{{ route('superadmin.statuses-edit', $s->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                        </tr>
                        @endforeach
                    </tbody>
                </table><br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="d-inline" action="{{ route('superadmin.statuses-store') }}" method="POST">
                    @csrf
                    @method('post')
