...
@section('page-title', 'Daftar Roles')
...
<div>
    <div class="card">
        <div class="card-header card-forestgreen">
            <h6 class="card-title pt-1">Data Role</h6>
                ...
                <table id="datatable" class="table table-sm table-hovered table-bordered table-hover table-striped datatable2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">{{ $r->role }}</td>
                            <td class="text-center" style="vertical-align: middle;"><a href="{{ route('superadmin.roles-edit', $r->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                        </tr>
                        @endforeach
                    </tbody>
                </table><br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="d-inline" action="{{ route('superadmin.roles-store') }}" method="POST">
                    @csrf
                    @method('post')
